...
to go
  ...
  ask turtles with [ wealth > 0 and wealth < 250 ] [ transact ]
  ;; extra actions to stabilise the economy
  ask turtles with [ wealth = 0 ] [beg]
  ask turtles with [ wealth > 250 ] [taxes]
...
to beg
  ;; asks a random turtle that has more than 100 money for 1 money
  ask one-of other turtles with [wealth > 100 ] [ set wealth wealth - 1 ]
  set wealth wealth + 1
end

to taxes
  ;; asks a rich turtle to pay 2 money to a another turtle
  set wealth wealth - 2
